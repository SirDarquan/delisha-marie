...
describe('url-utils', () => {
  describe('extractYouTubeVideoId', () => {
    ...
    it('should extract video ID from URL with additional parameters', () => {
      expect(extractYouTubeVideoId('https://www.youtube.com/watch?v=dQw4w9WgXcQ&feature=youtu.be')).toBe('dQw4w9WgXcQ');
      expect(extractYouTubeVideoId('https://www.youtube.com/watch?feature=youtu.be&v=dQw4w9WgXcQ')).toBe('dQw4w9WgXcQ');
    });
