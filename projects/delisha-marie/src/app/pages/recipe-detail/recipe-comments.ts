              ...
              <div
                ...
                <div
                  ...
                  <div class="flex flex-col">
                    <span class="comment-author text-xl font-black tracking-tight">{{ comment.author }}</span>
                ...
                <p class="comment-content text-lg leading-relaxed text-[var(--mat-sys-on-surface-variant)] mb-6">
                  {{ comment.content }}
                </p>
