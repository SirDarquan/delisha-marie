    ...
    <div class="into-the-box pt-12 pb-20">
      ...
      @if (recipe(); as r) {
        <article class="w-full">
          ...
          <!-- Metrics Bar -->
          <div
            class="max-w-4xl mx-auto flex items-center justify-center gap-8 text-sm font-bold border-y border-[var(--mat-sys-outline-variant)] py-8 mb-20">
          ...
          <div class="max-w-4xl mx-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-16">
              ...
              <aside class="lg:col-span-4 space-y-12">
                <div
                  class="bg-[var(--mat-sys-surface-container)] p-8 rounded-[2.5rem] sticky top-8">
