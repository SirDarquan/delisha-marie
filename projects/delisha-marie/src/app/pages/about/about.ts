      ...
      <div class="flex flex-col lg:flex-row gap-12">
        ...
        <div class="lg:w-2/3 space-y-16">
          ...
          <section class="grid grid-cols-1 gap-12 items-center">
            <div
              class="rounded-3xl overflow-hidden shadow-2xl skew-y-1 hover:skew-y-0 transition-transform duration-500">
              <img
            ...
            <div class="space-y-6 text-lg leading-relaxed text-[var(--mat-sys-on-surface)]">
              ...
              <p>
                I believe that every recipe tells a story—of its origin, the hands that prepared it,
                and the memories created while enjoying it. My goal with this blog is to share those
                stories with you, one ingredient at a time.
              </p>
              <div
